"""Dataset-free development inputs for CURE-Lite CCFR-v11.

This is an additive, top-level copy of the six frozen CC-SEA development
cases.  Keeping the CCFR runner outside ``cure_lite.experiment`` prevents
Python from eagerly importing the real Stage-A/cache pipeline merely to
...
def build_conservative_toy_case(
    ...
    if family_id not in {LEGACY_FAMILY, SUPPORT_FAMILY}:
        raise ValueError("unknown CCFR development family")
