"""Bounded-400 structural decision for CURE-Lite v23 PACRE-VC.
...
is relabelled and rebound to PACRE-VC so that a v23 result cannot be mistaken
for historical PAET or sealed v22 evidence.
"""
...
from .pacre_vc import PACRE_VC_CANDIDATE, PACRE_VC_VERIFIER_POLICY


PACRE_BOUNDED_RUN_ID = (
    "cure_lite_pacre_v23_vc_pmope_bounded_400_seed42_r1"
)
PACRE_BOUNDED_DECISION_SCHEMA = (
    "cure-lite-pacre-v23-vc-pmope-bounded-400-decision-v1"
)
PACRE_REFERENCE_DECISION_POLICY = (
    "exact_v21_predeclared_zero_level_inequalities_applied_to_"
    "pacre_vc_diagnostic_v1"
)
PACRE_VC_BOUNDED_RUN_ID = PACRE_BOUNDED_RUN_ID
PACRE_VC_BOUNDED_DECISION_SCHEMA = PACRE_BOUNDED_DECISION_SCHEMA
PACRE_VC_REFERENCE_DECISION_POLICY = PACRE_REFERENCE_DECISION_POLICY
...
def decide_coverage_state_pacre_bounded(
    ...
    *,
    ...
    """Apply the frozen bounded inequalities to a PACRE-VC checkpoint."""
...
CoverageStatePACREVCBoundedDecision = CoverageStatePACREBoundedDecision
...
__all__ = [
    ...
    "PACRE_BOUNDED_RUN_ID",
    "PACRE_REFERENCE_DECISION_POLICY",
    "PACRE_VC_BOUNDED_DECISION_SCHEMA",
    "PACRE_VC_BOUNDED_RUN_ID",
    "PACRE_VC_REFERENCE_DECISION_POLICY",
    "CoverageStatePACREBoundedDecision",
    "CoverageStatePACREVCBoundedDecision",
    "decide_coverage_state_pacre_bounded",
    "decide_coverage_state_pacre_vc_bounded",
]
