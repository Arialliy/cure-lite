...
and seal the metadata-only c4 compatibility lane after the consumed c2
...
C2_PREWRITE_FAILURE_TERMINAL_SHA256 = (
    "6984dc9df2c905a5b7bc4b1577a4d5e8c21d1e1f895217997ed6915050e0f43d"
)
...
def _validate_mode_contract_failure_terminal(
    ...
    # fixed source/evidence lineage and the C2 -> C4 transition are consumed.
