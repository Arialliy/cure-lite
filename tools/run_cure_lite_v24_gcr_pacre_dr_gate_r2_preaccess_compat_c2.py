#!/usr/bin/env python3
"""Compatibility-c2 entry point for the frozen v24 r2 gate adapter.
...
are verified by the compatibility-c2 supervisor.  All bootstrap, scientific
...
COMPAT_SUPERVISOR_MODULE = (
    "tools.cure_lite_v24_runtime_supervisor_preaccess_compat_c2"
)
_FROZEN_VERIFIER_IMPORT = (
    b"from tools.cure_lite_v24_runtime_supervisor import ("
)
_COMPAT_VERIFIER_IMPORT = (
    b"from tools.cure_lite_v24_runtime_supervisor_preaccess_compat_c2 "
    b"import ("
)
...
if __name__ == "__main__":
    ...
    legacy = _load_materialized_adapter(
        ...
        "materialized_for_preaccess_compat_c2"
    )
