#!/usr/bin/env python3
"""Compatibility-c5 entry point for the frozen v24 r2 gate adapter.
...
are verified by the compatibility-c5 supervisor.  All bootstrap, scientific
...
_COMPAT_VERIFIER_IMPORT = (
    b"from tools.cure_lite_v24_runtime_supervisor_preaccess_compat_c5 "
    b"import ("
)
